...
export default function ForgotPassword() {
  ...
  const [loadingState, setLoadingState] = useState<LoadingState>(STATES.IDLE);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://ai-recommendation-api.onrender.com/api/v1/auth/forgot-password', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              disabled={loadingState === STATES.LOADING}
